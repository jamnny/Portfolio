        ...
        <section id="project" className={styles.container}>
            ...
            <div className={styles.projectsContainer}>
                <a href="https://github.com/" target="_blank" className="hover">
                    ...
                    <h3>Little Haven Psychological Services</h3>
                    <p className={styles.des}>Web Responsive Tele-Counseling Application for a Psychological Clinic</p>
                </a>
